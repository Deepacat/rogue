...
2. Open the repository folder in a terminal and run `python3 dev_instance_setup.py` (Can read inside the python script using a text editor for more detail)
